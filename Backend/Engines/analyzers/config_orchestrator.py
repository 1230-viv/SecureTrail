...
File Upload) in parallel and returns structured results.
"""
...
async def run_config_analyzers(
    ...
    auth_vulns, cors_vulns, jwt_vulns, rate_vulns, upload_vulns = await asyncio.gather(
        auth_task, cors_task, jwt_task, rate_task, upload_task,
